# This file stores methods to create and store different test cases as json in data/test_graphs
...
def initialize():
    ...
    os.makedirs(f'{data_path}/test_graphs', exist_ok=True)
...
def save_as_json(file_path: str, matches_list):
    try:
        match_dict = {}
